...
#ifndef _BtOgre21_BtOgreGP_H_
#define _BtOgre21_BtOgreGP_H_
...
namespace BtOgre
{
	...
	protected:
        ...
        template<typename T> void loadV1IndexBuffer( Ogre::v1::HardwareIndexBufferSharedPtr ibuf,
                                                     const size_t& offset,
                                                     const size_t& previousSize,
                                                     const size_t& appendedIndexes )
		{
        ...
        template<typename T> void loadV2IndexBuffer( Ogre::AsyncTicketPtr asyncTicket,
                                                     const size_t& offset,
                                                     const size_t& perviousSize,
                                                     const size_t& appendedIndexes )
		{
