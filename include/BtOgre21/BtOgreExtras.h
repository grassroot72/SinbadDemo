...
#ifndef _BtOgre21_BtOgreExtras_H_
#define _BtOgre21_BtOgreExtras_H_
...
namespace BtOgre
{
	...
	public:
        ...
        LineDrawer( Ogre::SceneNode* node, Ogre::String datablockId, Ogre::SceneManager* smgr );
	...
	protected:
        ...
        static constexpr const char* mUnlitDatablockName{ "DebugLinesGenerated" };

		///ID of the datblock
        const Ogre::IdString mUnlitDatablockId;
