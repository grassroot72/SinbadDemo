...
macro( setupPluginFileFromTemplate BUILD_TYPE )
	...
	findPluginAndSetPath( ${BUILD_TYPE} OGRE_PLUGIN_RS_PARTICLEFX	Plugin_ParticleFX )
...
#		endif()
	...
	unset( OGRE_PLUGIN_RS_PARTICLEFX )
...
# BtOgre21 and bullet physics engine
function( setupBtOgre21 )
    include_directories( "${CMAKE_SOURCE_DIR}/include/BtOgre21/" )
endfunction()

# ImguiOgre21
function( setupImguiOgre21 )
    include_directories( "${CMAKE_SOURCE_DIR}/include/ImguiOgre21/" )
endfunction()
...
if( NOT IOS )
	...
	find_package( Bullet )
	if( NOT BULLET_FOUND )
	    message( "Could not find bullet. Please install bullet library" )
    else()
	    message( STATUS "Found Bullet" )
	    include_directories( ${BULLET_INCLUDE_DIRS} )
        set( OGRE_DEPENDENCY_LIBS ${OGRE_DEPENDENCY_LIBS} ${BULLET_LIBRARIES} )
    endif()
endif()
